...
const GameHome = (props) => {
  ...
  return (
    <>
      <Card style={{ marginTop: 12, height: 300 }}>
        <Container style={{ display: 'flex', alignItems: 'center', height: '100%', justifyContent: 'start' }}>
          ...
          <div>
            <Button variant="info" style={{ marginLeft: 3 }} onClick={addCart}>
              <FaShoppingCart />
            </Button>

            <Button variant="info" style={{ marginLeft: 3 }} onClick={addToFavorites}>
              <FaHeart />
            </Button>

            <Button variant="info" style={{ marginLeft: 3 }} onClick={nav}>
              <FaEye />
            </Button>
          </div>
        </Container>
